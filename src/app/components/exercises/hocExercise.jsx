...
import withHandlers from "../examples/hoc/withHandlers";
import withPropsStyles from "../examples/hoc/withPropsStyles";

const HocExercise = () => {
    const ComponentWithStyles = withPropsStyles(SimpleComponent);
    const ComponentWithHandlers = withHandlers(ComponentWithStyles);
